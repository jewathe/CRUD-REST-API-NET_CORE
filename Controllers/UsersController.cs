...
namespace TeaStoreApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            var logggedInUser = await userRepository.LoginUser(user.Email, user.Password);
            ...
            var claims= new[]
            {
                ...
                new Claim(ClaimTypes.Role, logggedInUser.Role),
            };
            ...
            return Ok( new
                {
                   access_token=jwt,
                   token_type="bearer",
                   user_id=logggedInUser.Id,
                   user_name=logggedInUser.Name,
                }
                );
        }
    }
